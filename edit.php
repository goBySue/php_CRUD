    ...
    <div class="container my-5"> 
        ...
        <?php 
            if(!empty($errorMessage)){
                ...
                <button class='btn-close' type ='button' data-bs-dismiss ='alert' aria-lable='Close' ></button>
        ...
        <div class="row mb-3">
         ...
         <div class="row mb-3">
            <lable class="col-sm-3 col-form-label">Phone</lable>
                 <div class="col-sm-6">
         ...
         if(!empty($successMessage)){
            ...
            <div class='row mb-3'>
                <div class ='offset-sm-3 col-sm-6'>
                    ...
                    <button type ='button' class ='btn-close' data-bs-dismissible='alert' aria-lable='Close'></button>                    
                    </div>
                </div>
